					...
					<?php while(have_posts()): the_post(); ?>
						<div class="post" id="<?php the_ID(); ?>">
							...
							<div class="upmetadata" class="clearfix">
								<div class="alignleft"><!--<?php _e('Author:'); ?>-->
									<span class="authorimg"><?php the_author(); ?></span> &brvbar; <!-- <?php _e('Date:'); ?>--> 
									<span class="dateimg"><?php echo get_the_date('Y-m-d'); ?></span> &brvbar; 
							...
							<div class="entry">
								<div class="post-content">
									<!-- <?php the_content('...<div class="moretext">(...全文全文...)</div>'.the_title('', '', false)); ?> -->
